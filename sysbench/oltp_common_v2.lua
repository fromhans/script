...
function cmd_prepare()
   ...
   local set_search_path = "SET search_path TO sbtest"
   con:query(set_search_path)
...
function set_search_path_pgsql(con)
   local query = "SET search_path TO sbtest"
   con:query(query)
end
